 ...
 * The Class Animal.
 * 
 * Initializes the frog with basic controls and animation
 */
public class Animal extends Actor {
	...
	/**
	 * Instantiates the main frogger sprites with basic animation
	 *
	 * @param imageLink The location of the image
	 */
	...
	/**
	 * Gets the points int and returns it 
	 *
	 * @return points
	 */
